...
open class DefaultRefreshHeader: UIView, RefreshableHeader {
    ...
    public let textLabel:UILabel = UILabel(frame: CGRect(x: 0,y: 0,width: 140,height: 20))
    ...
    override init(frame: CGRect) {
        ...
        self.isHidden = true
        spinner.tintColor = #colorLiteral(red: 0.5032528639, green: 0.812071383, blue: 0.7847238183, alpha: 1)
        //Default text
    ...
    override open var tintColor: UIColor!{
        didSet{
            textLabel.textColor = #colorLiteral(red: 0.5032528639, green: 0.812071383, blue: 0.7847238183, alpha: 1)
            spinner.color = #colorLiteral(red: 0.5032528639, green: 0.812071383, blue: 0.7847238183, alpha: 1)
            imageView.tintColor = #colorLiteral(red: 0.5032528639, green: 0.812071383, blue: 0.7847238183, alpha: 1)
        }
    }
}
